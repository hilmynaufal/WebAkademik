...
<div class="col-md-12 p-5 pt-2">
   <h3><i class="fas fa-paperclip mr-2"></i>JADWAL</h3><hr>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>{{ $val->sks }}</td>
          ...
          <td><a class="fas fa-edit bg-warning p-2 text-white rounded edit-modal-click" data-Nip="{{ $val->Nip }}" data-kode_pelajaran="{{ $val->kode_pelajaran }}" data-id="{{ $val->Id_jdwl }}">EDIT</a></td>
         <td><a href="javascript:;" data-toggle="modal" onclick="deleteData({{ $val->Id_jdwl }})" data-target="#DeleteModal" class="fas fa-trash bg-danger p-2 text-white rounded">DELETE</a></td>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-header">
        ...
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          ...
          <div class="form-group">
                  <label>Waktu</label>
            <input type="text" id="edit-waktu" name="waktu" class="form-control" id="edit-waktu">      
          </div>
          <div class="form-group">
                  <label>SKS</label>
...
<script type="text/javascript">
  $(document).on("click", ".edit-modal-click", function () {
    ...
    var waktu = rowCells.eq(4).text();
    var sks = rowCells.eq(5).text();
     $("#edit-id").val(id);
     $("#edit-Nip").val(nip);
